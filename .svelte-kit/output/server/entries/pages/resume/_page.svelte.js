...
function _page($$renderer) {
  ...
  for (let $$index_1 = 0, $$length = each_array.length; $$index_1 < $$length; $$index_1++) {
    ...
    if (role.logo) {
      $$renderer.push("<!--[-->");
      $$renderer.push(`<div class="experience-logo svelte-1mijfb4" style="width: 3.5rem; height: 3.5rem"><img${attr("src", role.logo)}${attr("alt", `${stringify(role.company)} logo`)} class="experience-logo-img svelte-1mijfb4" width="56" height="56" style="width: 100%; height: 100%; object-fit: contain"/></div>`);
    } else {
      $$renderer.push("<!--[!-->");
    }
    $$renderer.push(`<!--]--> <div><h3 class="text-2xl font-bold" style="color: var(--color-text-on-box)">${escape_html(role.role)}</h3> <p class="text-lg" style="color: var(--color-text-on-box); opacity: 0.9">`);
    if (role.companyLink) {
      $$renderer.push("<!--[-->");
      $$renderer.push(`<a${attr("href", role.companyLink)} target="_blank" rel="noopener noreferrer" class="company-link svelte-1mijfb4" style="color: var(--color-text-on-box)">${escape_html(role.company)}</a>`);
    } else {
      $$renderer.push("<!--[!-->");
      $$renderer.push(`${escape_html(role.company)}`);
    }
    $$renderer.push(`<!--]--> `);
  ...
  for (let $$index_2 = 0, $$length = each_array_2.length; $$index_2 < $$length; $$index_2++) {
    ...
    $$renderer.push(`<article class="p-5 rounded-xl resume-card svelte-1mijfb4"><div class="flex items-center gap-3 mb-2">`);
    if (project.logo) {
      $$renderer.push("<!--[-->");
      $$renderer.push(`<div class="project-logo-shell svelte-1mijfb4" style="width: 3.5rem; height: 3.5rem"><img${attr("src", project.logo)}${attr("alt", `${stringify(project.name)} logo`)} class="project-logo-img svelte-1mijfb4" width="56" height="56" style="width: 100%; height: 100%; object-fit: contain"/></div>`);
    } else {
      $$renderer.push("<!--[!-->");
    }
    $$renderer.push(`<!--]--> <h3 class="text-xl font-bold" style="color: var(--color-text-on-box)">${escape_html(project.name)}</h3></div> <p class="leading-relaxed text-sm" style="color: var(--color-text-on-box); opacity: 0.9">${escape_html(project.description)}</p></article>`);
  }
