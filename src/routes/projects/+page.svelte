...
<div class="min-h-screen px-6 py-12">
	<div class="mx-auto max-w-6xl">
		...
		<div class="grid gap-8 md:grid-cols-2">
			{#each [{ title: 'Burnstack.ai', logo: burnstackLogo, description: 'Startup cost command center SaaS that centralizes cloud and AI spend (OpenAI, Anthropic, OpenRouter, Supabase, Tavily), with secure multi-tenant workspaces, encrypted provider integrations, automated sync/ingestion pipelines, and invoice-based cost import for reliable burn tracking.', tech: ['Next.js', 'Tailwind', 'TypeScript'], link: 'https://burnstack.ai', tags: ['Startup'], status: 'To Be Released' }, { title: 'QuantVision.ai', logo: quantvisionLogo, description: 'A SaaS platform for company financials and stock market analytics integrated with advanced agentic AI capabilities.', tech: ['Next.js', 'Python', 'Tailwind', 'Google Cloud', 'LangChain DeepAgents', 'LangFuse'], link: '', tags: ['Startup'], status: 'To Be Released | Delayed (Cost)' }, { title: 'LLMfit.io', logo: llmfitLogo, description: 'A site to aid users looking to see if their hardware will be able to run a specific LLM model locally.', tech: [], link: 'https://llmfit.io', tags: [], status: 'Live' }] as project, i}
